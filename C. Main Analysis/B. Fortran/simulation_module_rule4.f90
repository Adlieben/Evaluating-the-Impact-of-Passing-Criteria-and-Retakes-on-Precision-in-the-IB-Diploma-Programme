! -------------------------------------------------------------------------------------
! simulation_module_rule4.f90
! Rule 4 = No HL/SL checks, and total <18 => fail (instead of <24).
! Conditions 2,3 are removed. Condition 1 changed to 18.
! -------------------------------------------------------------------------------------

subroutine compute_true_passFlag4( &
  ...
  deallocate(temp, cnt, tk_ee_count)
  return
end subroutine compute_true_passFlag4


subroutine add_error_scale_total_and_assign4( &
     data, diagVar, scaleFactor, mask, group, nrows, ncols, nGroups, &
     nBound, nBoundMax, bound_ub, grade_val, &
  ...
  deallocate(temp, totals, finalGrades, cnt, student_totals, hl_totals, sl_totals, &
             passFlag, failCounter, tk_ee_count, grade_23_count)
  return
end subroutine add_error_scale_total_and_assign4

subroutine check_seed_size4(n, ierr)
...
end subroutine check_seed_size4

subroutine init_fortran_seed4(ierr)
  ...
  deallocate(seed)
end subroutine init_fortran_seed4