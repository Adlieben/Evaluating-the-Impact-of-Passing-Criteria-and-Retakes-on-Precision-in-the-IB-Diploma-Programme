subroutine add_error_scale_total_and_assign_retake4( &
...
deallocate(reasonDiff, score100, scoreNov, retake_probability, retake_decision, failReasonsObs,  &
  ...
  return
  end subroutine add_error_scale_total_and_assign_retake4

  subroutine init_fortran_seed_retake4(ierr)
  implicit none
  integer, intent(out) :: ierr
  integer :: n, i
  ...
  deallocate(seed)
  return
  end subroutine init_fortran_seed_retake4
